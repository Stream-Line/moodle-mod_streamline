<head>	<script>
		...
		$( document ).ready(function() {
			...
			if(mobile) {
				...
				$('#chat_mobile_button').click(function() {
					...
					updatChatModuleHeight(window.innerHeight);
				});
		...
		//Sets the chat module height based on the window height
		function updatChatModuleHeight(containerHeight) {
			if(mobile) {
				containerHeight = window.innerHeight;
				var webinarButtonHeight = $('#webinar_buttons').height();
			} else {
